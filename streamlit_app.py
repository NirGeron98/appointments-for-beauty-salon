...
def main():
    ...
    page = st.sidebar.selectbox("Select Page", ["Make a Reservation", "Admin Login"], key="page_select")
    ...
    if page == "Make a Reservation":
        ...
        service = st.selectbox("Service", ["Hands", "Feet", "Hands + Feet", "Cosmetics"], key="service_select")
